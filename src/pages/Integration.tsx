        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold">Shopify Entegrasyonu</h2>
            </div>
            {integration && (
              <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                integration.is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'
              }`}>
          ...
          {!integration ? (
            <>
              <div className="bg-blue-50 border border-blue-200 p-4 rounded mb-4 flex gap-3">
              ...
              <form onSubmit={handleInstallApp} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border rounded px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                <div className="flex justify-end">
                  ...
                  >
                    {saving ? "Yönlendiriliyor..." : "Shopify'a Bağlan"}
                  </button>
                </div>
              </form>
            </>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-900 mb-1">Bağlı Mağaza:</h3>
